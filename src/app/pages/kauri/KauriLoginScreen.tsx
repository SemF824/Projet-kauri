...
export function KauriLoginScreen() {
  ...
  return (
    ...
    >
      {/* Motif de fond — coquillages flottants */}
      ...
      >
        ...
        <h1
          ...
          style={{ fontSize: '2rem', fontWeight: 700, letterSpacing: '0.2em' }}
        >
          KAURI
        </h1>
      ...
      >
        <div className="p-6 flex flex-col h-full">
          ...
          {step !== 'welcome' && (
            <button
              onClick={() => { setStep(step === 'pin' ? 'phone' : 'welcome'); setError(''); }}
          ...
          {step === 'welcome' && (
            <div className="flex flex-col flex-1">
              ...
              <p className="text-sm mb-8" style={{ color: '#4A4A4A' }}>
                Connectez-vous à votre compte KAURI pour continuer.
              </p>
              ...
              <button
                ...
                style={{
                  background: isLoading ? '#f0fdf4' : 'linear-gradient(135deg, #006D77, #0D9488)',
                  borderColor: '#006D77',
                  color: 'white',
              ...
              >
                ...
                <div className="text-left flex-1">
                  <p style={{ fontWeight: 600, fontSize: '0.95rem' }}>
                    {isLoading ? 'Vérification…' : 'Connexion biométrique'}
                  </p>
          ...
          {step === 'phone' && (
            <div className="flex flex-col flex-1">
              ...
              <p className="text-sm mb-6" style={{ color: '#4A4A4A' }}>
                Entrez votre numéro de téléphone enregistré sur KAURI.
              </p>

              {/* Indicatif + champ */}
              <div
                className="flex items-center gap-2 rounded-2xl px-4 py-3 mb-3 border-2"
                style={{
                  borderColor: error ? '#B05B3B' : '#006D77',
                  background: 'white',
                }}
              >
                <span
              ...
              {error && (
                <p className="text-xs mb-3" style={{ color: '#B05B3B' }}>
                  {error}
                </p>
              )}
              ...
              <p className="text-center text-xs mt-4" style={{ color: '#94A3B8' }}>
                Un code vous sera envoyé par SMS pour confirmer votre identité.
              </p>
            </div>
          )}
          ...
          {step === 'pin' && (
            <div className="flex flex-col flex-1">
              ...
              <p className="text-sm mb-6" style={{ color: '#4A4A4A' }}>
                Entrez votre code PIN KAURI à 4–6 chiffres.
              </p>
              ...
              <div className="flex justify-center gap-3 mb-4">
                {Array.from({ length: 6 }).map((_, i) => (
                  <div
                    ...
                    style={{
                      background: i < pin.length ? '#006D77' : '#E2E8F0',
      ...
      <style>{`
        ...
        @keyframes pulse {
          0%, 100% { opacity: 0.25; transform: scale(1.35); }
